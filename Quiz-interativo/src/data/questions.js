...
options: ["useEffect", "useState", "useProps", "useClass"],  answer: "useState", 
points: 2 
}, 
{ 
id: 2, 
question: "Qual hook é usado para efeitos colaterais no React?",  options: ["useMemo", "useEffect", "useReducer", "useRef"],  answer: "useEffect", 
points: 3 
}, 
{ 
id: 3, 
question: "Qual é a forma correta de passar dados entre componentes?",  options: ["Hooks", "Props", "State", "Redux"], 
answer: "Props", 
points: 1 
}, 
{ 
...
{ 
id: 5, 
question: "Qual comando cria um novo projeto React com Vite?",  options: [ 
...
options: ["useReducer", "useMemo", "useEffect", "useCallback"],  answer: "useMemo", 
points: 5
}, 
{ 
id: 8, 
question: "Qual hook é usado para funções que precisam ser  memorizadas?", 
options: ["useEffect", "useCallback", "useMemo", "useState"],  answer: "useCallback", 
points: 4 
}, 
{ 
id: 9, 
question: "Em React, como chamamos o processo de atualizar a interface  quando o estado muda?", 
options: ["Binding", "Re-renderização", "Rebuild", "Patch"],  answer: "Re-renderização", 
points: 3 
}, 
{ 
id: 10, 
